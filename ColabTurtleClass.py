...
'''
'''
  Modified version of Abstrqt's ColabTurtleClass library
  @link https://github.com/abstrqt/ColabTurtleClass
'''
...
#디폴트 각도 수정 DEFAULT_TURTLE_DEGREE = 270

DEFAULT_TURTLE_DEGREE = 90
